...
N -510 -190 -440 -190 {lab=VSS}
N -440 -210 -440 -190 {lab=VSS}
N -440 -410 -440 -270 {lab=ENABLE}
N 160 -260 580 -260 {lab=#net2}
N 160 -220 490 -220 {lab=#net3}
N 160 -180 410 -180 {lab=#net4}
N -440 -190 -350 -190 {lab=VSS}
N -350 -210 -350 -190 {lab=VSS}
N -350 -190 -290 -190 {lab=VSS}
...
C {gnd.sym} -510 -120 0 0 {name=l10 lab=GND}
...
C {isource.sym} -290 -240 0 0 {name=I_aux value=10u}
...
C {vsource.sym} -510 -150 0 0 {name=V3 value=0}
