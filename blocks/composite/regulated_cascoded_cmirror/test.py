...
if __name__ == "__main__":
    ...
    # DRC
    drc_result = selected_pdk.drc_magic("gds/top.gds", "TOP", output_file=Path("DRC/"))

    # LVS
    netgen_lvs_result = selected_pdk.lvs_netgen(
        "gds/top.gds", "TOP", netlist="gds/top_new.spice", output_file_path=Path("LVS/"), copy_intermediate_files=True
    )
