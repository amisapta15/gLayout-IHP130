...
def generate_self_biased_current_mirror_netlist(
    ...
    **kwargs,
    ...
    source_netlist += (
        f"XA {drain_net_in} {gate_net} {A_source_C_drain_net} {bulk_net} "
        f"{model_name} l={length} w={width} m={mtop}\n"
    )
    source_netlist += (
        f"XB {drain_net_out} {gate_net} {B_source_D_drain_net} {bulk_net} "
        f"{model_name} l={length} w={width} m={mtop}\n"
    )
    source_netlist += (
        f"XC {A_source_C_drain_net} {A_source_C_drain_net} {bulk_net} {bulk_net} "
        f"{model_name} l={length} w={width} m={mtop}\n"
    )
    source_netlist += (
        f"XD {B_source_D_drain_net} {A_source_C_drain_net} {bulk_net} {bulk_net} "
        f"{model_name} l={length} w={width} m={mtop}\n"
    )
