...
# # @validate_arguments
# def self_biased_cascode_current_mirror_1000x(
#         pdk: MappedPDK,
#         Width: float = 1,
...
if __name__ == "__main__":
    selected_pdk=gf180
    comp = self_biased_cascode_current_mirror_base(selected_pdk,length=5*selected_pdk.get_grule('poly')['min_width'],Width=5, device='nfet')
    #comp.pprint_ports()
